...
<!-- Bootstrap Core CSS -->
    ...
    <link href="Calendar/jquery-ui.css" rel="stylesheet" type="text/css">
</head>
        ...
        <div id="page-wrapper">
			...
			<div class="row">
				<div class="panel panel-yellow">
                        ...
                        <form role="form" name="createEvent" action="event" method="post" onsubmit="return validateActivity()">
						<div class="panel panel-default"><br/>
                            <div class="panel-body">
                                ...
                                <div class="row">
                                	<div class="form-group">
                                		...
                                		<div class="col-md-10">
                                        	<input name="eventCommInvolved" class="form-control" >
                                       		<p id="message2" ></p>
                                        </div>
                                	</div>
                                </div>
                                ...
                                <div class="row">
                                	<div class="form-group">
                                		...
                                		<div class="col-md-4">
                                        	<input type="date" id="date" name="eventDate" class="form-control"  >
                                        	<p id="message3" ></p>
                                        </div>
                                	...
                                	<div class="form-group">
                                		...
                                		<div class="col-md-4">
                                			<div class="form-group input-group">
	                                            ...
	                                            <input name="eventCost" type="number" step="0.01" placeholder="00.00" min="00.00"class="form-control" oninput="validity.valid||(value='');">
	                                        </div>
	                                        <p id="message5" ></p>
	                                    </div>
	                                    ...
	                                    <div class="col-md-4">
	                                    	<select class="form-control" name="eventType" >
	                                        	<option value="">-- Pilih --</option>
	                                            <option value="A">A: Program Pembelajaran Sepanjang Hayat</option>
	                                            <option value="B">B: Program Pemerkasaan Ekonomi</option>
	                                        </select>
	                                        <p id="message6" ></p>
                                        </div>
                                	</div>
                                ...
                                <div class="row">
                                	<div class="form-group">
                                		...
                                		<div class="col-md-10">
                                			<input name="eventVenue" class="form-control"  >
                                			<p id="message7" ></p>
                                		</div>
                                	</div>
                                </div>
                            ...
                            <input type="hidden" name="action" value="createEventInfo" />
